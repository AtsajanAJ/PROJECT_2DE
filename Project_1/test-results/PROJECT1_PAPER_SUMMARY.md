# รายงานสรุปผลการทดสอบ Project_1 สำหรับ Paper

**วันที่สร้างรายงาน:** 30 พฤศจิกายน 2025  
**เวอร์ชันระบบ:** REST API (Spring Boot)  
**สถาปัตยกรรม:** RESTful Web Services
...
3. [Performance Testing - Initial Version](#performance-testing---initial-version)
4. [Performance Testing - Improved Version](#performance-testing---improved-version)
...
| หมวดหมู่ | รายละเอียด |
|---------|-----------|
| **Architecture** | REST API (Spring Boot) |
| **Protocol** | HTTP REST |
| **Framework** | Spring Boot, Apache Jena |
| **Functional Test Cases** | 28 test cases |
| **Performance Test Cases (Initial)** | 65 test cases |
| **Performance Test Cases (Improved)** | 65 test cases |
| **Error Rate** | 0% |
| **Success Rate** | 100% |

### คุณสมบัติหลัก

- ✅ Authentication และ Authorization ด้วย JWT Token
- ✅ User Profile Management
- ✅ Restaurant Recommendation System
- ✅ Search และ Filtering Capabilities
...
- Runner Types และ Budget Levels มี performance ดีมาก (73-78 req/s)
...
**รายงานนี้สร้างขึ้นสำหรับ Paper**  
**วันที่:** 30 พฤศจิกายน 2025  
**ไฟล์อ้างอิง:**
- Functional Test: `functional_test_results_2025-11-23_19-47-21.csv`
- Performance Initial: `performance_test_initial_2025-11-23_21-03-35.csv`
